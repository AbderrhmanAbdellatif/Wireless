...
public class Activity2 extends AppCompatActivity {
    ...
    public DeviceListAdapter bluetoothAdapter;
    ...
    Button button , availableDevices;
    Button mPairedBtn, visible;
    BluetoothAdapter bluetoothAdapter;
    BroadcastReceiver mReceiver;
    ArrayList<String> mArrayAdapter = new ArrayList<>();

    TextView btstatus, devices;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        devices = findViewById(R.id.showdevices);
        availableDevices = findViewById(R.id.devices);
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)){
                ...
                bluetoothAdapter = new DeviceListAdapter(context, R.layout.device_adapter_view, mBTDevices);
                lvNewDevices.setAdapter(bluetoothAdapter);
            }
        }
    };
    @Override
